...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/webbeaver/Рабочий стол/temp/test-event/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/webbeaver/Рабочий стол/temp/test-event/public/storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'admin.login','admin.register','admin.home','admin.home','admin.events.index',
'admin.events.show','admin.users.index','admin.users.show','admin.logout','storage.local',);
        registerArgumentsSet('views', 
'admin.auth.login','admin.auth.logout','admin.auth.register','admin.events.index','admin.events.partials.all-events',
'admin.events.partials.my-events','admin.events.show','admin.partials.footer','admin.partials.header','admin.partials.sidebar',
'admin.users.show','layouts.admin','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button',
